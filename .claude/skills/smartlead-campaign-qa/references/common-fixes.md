...
In mode 3: build the `save_campaign_sequences` payload with mechanical fixes applied. After save attempt:
- If save succeeded: re-fetch and confirm changes stuck. Run a fresh QA pass to verify nothing was damaged.
