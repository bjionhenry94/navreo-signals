...
# The Navreo cold-email VOICE (real-email few-shots, templates, rotation and
...
def offer_email(p: dict, ip: str):
    ...
    # The Navreo email voice (few-shots, templates, opener/CTA/P.S rotation and
    # the validators) is the single source of truth in navreo_voice.py, so any
    # other endpoint or tool can reuse the exact same logic.
    ...
    for attempt in (1, 2, 3):
        try:
            ...
            validate_email(email, lead_magnet)  # raises ValueError -> retry
